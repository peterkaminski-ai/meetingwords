...
const S = {
  ...
  "login.ownerSignIn": {
    en: "Owner sign-in — this instance has one owner and no accounts.",
    es: "Acceso del propietario: esta instancia tiene un solo propietario y no hay cuentas.",
    zh: "所有者登录——此实例只有一位所有者，没有账户。",
    hi: "स्वामी साइन-इन — इस इंस्टेंस का एक ही स्वामी है, कोई खाते नहीं।",
    ar: "تسجيل دخول المالك — لهذه النسخة مالك واحد ولا توجد حسابات.",
    pt: "Entrada do proprietário — esta instância tem um único proprietário e não há contas.",
    fr: "Connexion du propriétaire — cette instance a un seul propriétaire et aucun compte.",
    ru: "Вход владельца — у этого экземпляра один владелец и нет учётных записей.",
    ja: "オーナーサインイン — このインスタンスの所有者は一人で、アカウントはありません。",
    de: "Eigentümer-Anmeldung — diese Instanz hat einen Eigentümer und keine Konten.",
    ko: "소유자 로그인 — 이 인스턴스에는 소유자가 한 명뿐이며 계정이 없습니다.",
    it: "Accesso del proprietario: questa istanza ha un solo proprietario e nessun account.",
  },
  "login.setupToken": {
  ...
  "login.firstVisit": {
    en: "First visit — choose the owner passphrase.", es: "Primera visita: elige la frase de acceso del propietario.",
    zh: "首次访问——请设置所有者口令。", hi: "पहली बार — स्वामी पासफ़्रेज़ चुनें।",
    ar: "الزيارة الأولى — اختر عبارة مرور المالك.", pt: "Primeira visita — escolha a frase-senha do proprietário.",
    fr: "Première visite — choisissez la phrase secrète du propriétaire.",
    ru: "Первый вход — задайте парольную фразу владельца.", ja: "初回アクセスです。オーナーパスフレーズを設定してください。",
    de: "Erster Besuch — wähle die Eigentümer-Passphrase.", ko: "첫 방문입니다. 소유자 패스프레이즈를 설정하세요.",
    it: "Prima visita: scegli la passphrase del proprietario.",
  },
  "login.guestHint": {
